...
\section{General considerations about DD-minisurveys in VRO}
\label{sec:methods}
\subsection{DD mini-surveys: main constraints}
\subsection{Supernova metric to assess observing strategy}
